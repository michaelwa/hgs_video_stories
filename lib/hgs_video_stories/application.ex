defmodule HgsVideoStories.Application do
  ...
  def start(_type, _args) do
    children = [
      HgsVideoStoriesWeb.Telemetry,
      HgsVideoStories.Repo,
      {Ecto.Migrator,
      ...
      HgsVideoStoriesWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: HgsVideoStories.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    HgsVideoStoriesWeb.Endpoint.config_change(changed, removed)
    :ok
  end
